const FullWidthTitleSection = ({ title, subTitle, img }) => {
  return (
    ...
    >
      <div className="bg-black bg-opacity-30 px-10 w-full !h-[500px] flex align-start  ">
        <div className="max-w-screen-xl mx-auto w-full pt-28">
          <p className="text-white text-xl text-center">{subTitle}</p>
          <h1 className="text-6xl text-white text-center font-medium font-Cormorant uppercase">
            {title}
          </h1>
        </div>
      </div>
